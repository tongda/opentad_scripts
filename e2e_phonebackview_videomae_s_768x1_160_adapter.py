_base_ = [
    "../../_base_/datasets/b11_phone_motion2_backview/e2e_train_trunc_test_sw_256x224x224.py",  # dataset config
...
workflow = dict(
    ...
    val_loss_interval=-1,
    val_eval_interval=20,
    val_start_epoch=400,
    end_epoch=600,
)

work_dir = "exps/lean/adatad/e2e_actionformer_videomae_s_768x1_160_adapter"
